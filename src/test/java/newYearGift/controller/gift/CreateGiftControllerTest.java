...
class CreateGiftControllerTest {

    private GiftService giftService;
    private CandyService candyService;
    private ExceptionHandler exceptionHandler;
    private CreateGiftController controller;
    ...
    void start(Stage stage) throws Exception {
        ...
        controller = new CreateGiftController(giftService, candyService, exceptionHandler);

        FXMLLoader loader = new FXMLLoader(NewYearGiftApplication.class.getResource("../view/gift/createGift.fxml"));
    ...
    @Test
    void createGift_whenSuccessfully_showsMessage(FxRobot robot) {
        Long id = 1L;
        Candy candy = spy(new Candy(
                1L,
                "name",
        ...
        when(candyService.getCandyById(id))
                .thenReturn(candy);
        when(giftService.createGift(any()))
                .thenReturn(gift);
        ...
        robot.clickOn("#createGiftButton");


        Assertions.assertThat(controller.getCreateGiftNotificationLabel())
                .hasText("Yours new gift Id is " + id);
    }

    @Test
    void createGift_whenConstraintViolationExceptionOccurs_showsMessage(FxRobot robot) {
        Long id = 1L;
        Candy candy = spy(new Candy(
                1L,
                "name",
    ...
    @Test
    void createGift_whenBusinessExceptionOccurs_showsMessage(FxRobot robot) {
        Long id = 1L;
        Candy candy = spy(new Candy(
                1L,
                "name",
    ...
    @Test
    void clearAllFields_whenSuccessfully_clearGiftDataFields(FxRobot robot) {
        Long id = 1L;
        Candy candy = spy(new Candy(
                1L,
                "name",
        ...
        robot.clickOn("#clearGiftDataFieldsButton");


        Assertions.assertThat(controller.getGiftNameField()).hasText("");
        Assertions.assertThat(controller.getGiftDescriptionArea()).hasText("");
        Assertions.assertThat(controller.getGiftAuthorField()).hasText("");
